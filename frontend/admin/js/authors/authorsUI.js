...
function renderAuthorTableRow(item) {
  ...
  if (item.is_deleted == 1) {
    setDeletedButton = `            
        <button class="table-row-button show-confirmation-modal" data-mode="restore" data-intent="showDelete" data-intent="deleteAuthor" data-entity="author" data-id="${item.id}">
          <svg
              width="25px"
              height="25px" 
              viewBox="0 0 24 24"
  ...
  return `
    <div class="flex-table-row">
        ...
        <div>
            <button class="cascade-show-books-button" data-entity="book" data-intent="cascadeBooks" data-filterf="author_id" data-id="${item.id}">
              Show Books
