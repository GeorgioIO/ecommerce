        ...
        <div id="user-dashboard">
                <ul id="user-dashboard-sidebar">
                    ...
                    <li class="sidebar-list" data-section="orders">
                        <button>
                            Orders
                            <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" fill="none" viewBox="0 0 16 16">
                                <path fill="#000" fill-rule="evenodd" d="M9.02.678a2.25 2.25 0 0 0-2.04 0L1.682 3.374A1.25 1.25 0 0 0 1 4.488v6.717c0 .658.37 1.26.956 1.56l5.023 2.557a2.25 2.25 0 0 0 2.042 0l5.023-2.557a1.75 1.75 0 0 0 .956-1.56V4.488c0-.47-.264-.9-.683-1.114L9.021.678zM7.66 2.015a.75.75 0 0 1 .68 0l4.436 2.258-1.468.734-4.805-2.403 1.157-.59zM4.84 3.45l-1.617.823L8 6.661l1.631-.815-4.79-2.396zM2.5 5.588v5.617c0 .094.053.18.137.223l4.613 2.348V7.964L2.5 5.588zm10.863 5.84L8.75 13.776V7.964l4.75-2.375v5.617a.25.25 0 0 1-.137.223z" clip-rule="evenodd"/>
                            </svg>
                        </button>
                    </li>
